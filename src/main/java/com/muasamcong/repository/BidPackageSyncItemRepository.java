...
public interface BidPackageSyncItemRepository extends JpaRepository<BidPackageSyncItem, Long> {
    ...
    @Query("SELECT item FROM BidPackageSyncItem item " +
    ...
    List<BidPackageSyncItem> findSyncQueue(
    ...
    List<BidPackageSyncItem> findRefreshQueue(
    ...
    Page<BidPackageSyncItem> searchTracking(
