...
public class BidPackageSyncSystemController {
    private final BidPackageSyncSystemService service;
    ...
    public ApiResponse<BidPackageSyncSystemResult> updateConfig(@RequestBody BidPackageSyncSystemUpdateRequest request) {
        log.info("Update bid package sync system config enabled={}, intervalMinutes={}, batchLimit={}, importRootPaths={}",
                request.enabled(), request.intervalMinutes(), request.batchLimit(),
